export default function PrivacyPolicyPage() {
  return (
    <main className="mx-auto max-w-2xl px-6 py-16 text-sm text-foreground">
      <h1 className="font-heading mb-8 text-3xl">Privacy Policy</h1>

      <h2 className="font-heading mt-6 text-lg">Information We Collect</h2>
      ...
      <h2 className="font-heading mt-6 text-lg">How We Use Your Data</h2>
      ...
      <h2 className="font-heading mt-6 text-lg">Third-Party Sharing</h2>
      ...
      <h2 className="font-heading mt-6 text-lg">Your Rights</h2>
      <p className="mt-2 text-muted">
      ...
      <h2 className="font-heading mt-6 text-lg">Data Retention</h2>
      <p className="mt-2 text-muted">
      ...
      <h2 className="font-heading mt-6 text-lg">Governing Law &amp; Contact</h2>
      <p className="mt-2 text-muted">
